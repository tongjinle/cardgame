...
// 逆鳞
// 对敌方3张卡牌造成{0}点绝对伤害，若目标拥有【光之壁】或【反射壁】则伤害提升200%
// Lo_op_rd@3#Con_ac_has_sk@14006@14007?Ef_abs@Num_int:60||Ef_abs@Num_int:20
...
export default class nilin extends Skill {
  constructor() {
    super();
