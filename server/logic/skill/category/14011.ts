...
// 冰冻之躯
// 受到攻击时，对攻击者造成{0}点绝对伤害，有{1}%概率使攻击者进入冰冻状态
// Con_sk_fun@Fun_phy?Lo_ca#Ef_abs@Num_int:10#Con_per@Num_int:5:20?Ef_buf@103@1
...
export default class bingdongzhiqu extends Skill {
  constructor() {
    super();
