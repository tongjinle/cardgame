...
// 火焰之躯
// 受到攻击时,对攻击者造成{0}点绝对伤害，并有{1}%概率使攻击者进入烧伤状态
// Con_sk_fun@Fun_phy?Lo_ca#Ef_abs@Num_int:20#Con_per@Num_int:5:30?Ef_buf@101@1
...
export default class huoyanzhiqu extends Skill {
  constructor() {
    super();
