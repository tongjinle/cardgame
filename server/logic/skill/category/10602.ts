...
// 龙之波动
// 对敌方2张卡牌造成{0}点绝对伤害，若目标拥有【光之壁】或【反射壁】则伤害提升200%
// Lo_op_rd@2#Con_ac_has_sk@14006@14007?Ef_abs@Num_int:60||Ef_abs@Num_int:20
...
export default class longzhibodong extends Skill {
  constructor() {
    super();
